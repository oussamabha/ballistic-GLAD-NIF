...
fig.savefig(OUT / "P4_neb_hop_barrier.png", dpi=200)
plt.close(fig)
print("Fig 1 written")
...
ax.set_xticks(x); ax.set_xticklabels(angles, fontsize=7)
ax.set_ylabel("Interpenetration $>10\%$ (% of atoms)")
...
fig.savefig(OUT / "P4_geometry_kinetics_decomposition.png", dpi=200, bbox_inches="tight")
plt.close(fig)
print("Fig 2 written")
