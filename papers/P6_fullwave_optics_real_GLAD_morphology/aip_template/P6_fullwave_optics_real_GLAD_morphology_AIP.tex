...
depolarisation.}
\label{fig:mueller}
\end{figure} With $n = 3$ realisations the spread across seeds
...
increases monotonically with deposition angle, the expected shadowing
direction, while the imaginary part of the effective index falls
correspondingly as the film becomes more void-dominated.
