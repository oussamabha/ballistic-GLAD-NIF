...
($p=0.629$) -- ever clears the permutation-test bar (best $p=0.09$ for
...
elemental metals ($p=0.24$), oxides/fluorides ($p=0.55$), and
...
$X^2=4.35$, $df=6$, $p=0.629$: \textbf{not cleared}. A secondary,
...
tests, and also ruled out (combined $p=0.629$ and $p=0.390$
